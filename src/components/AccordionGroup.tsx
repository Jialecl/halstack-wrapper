import React, { ReactNode, SVGProps, ReactElement } from "react";
...
type AccordionGroupPropTypes = {
   ...
   */
  children:
    | ReactElement<AccordionPropsType>[]
    | ReactElement<AccordionPropsType>;
};
...
const AccordionGroup = ({
  ...
  margin,
  children,
}: AccordionGroupPropTypes) => (
  <DxcAccordionGroup
    defaultIndexActive={defaultIndexActive}
